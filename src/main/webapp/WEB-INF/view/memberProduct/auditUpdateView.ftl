<div class="pageContent">
    <form method="post" action="/member/product/audit/dialog/view/another/update" class="pageForm required-validate"
        ...
        <#--<input type="hidden" name="servicePeopleCall" value="${(deafult.servicePeopleCall)!}">-->
            ...
            <input type="hidden" id="marketingPrice" name="marketingPrice" value="${(memberProductBo.marketingPrice)!0}">
            <input type="hidden" id="zlyChannelPrice" name="zlyChannelPrice" value="${(memberProductBo.zlyChannelPrice)!0}">
            <dl>
                <dt>类目：</dt>
                <dd>
                    <select name="type" class="required" onchange="getSubType_u_v($(this).val())">
            ...
            <dl>
                <dt>子类目：</dt>
                <dd>
                    <select id="subType_u_v" name="subType" class="required">
                    <#if subTypeList??>
            ...
            <dl>
                <dt>可报销金额：</dt>
                <dd>
                    <#--<input type="text" id="realPrice" name="realPrice" class="required textInput number price_validate_可报销金额" alt="" maxlength="12"-->
                    <input type="text" id="realPrice" name="realPrice" class="required textInput number" alt="" maxlength="12"
                           size="20"
...
<script>
    //类目级联js
    function getSubType_u_v(type) {
        var subType = $("#subType_u_v");

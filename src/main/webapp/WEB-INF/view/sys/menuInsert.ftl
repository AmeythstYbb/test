...
<script>
    $("#menuBtn").click(function () {
        $.jBox.open("iframe:/menu/tree/get", "选择", 300, 420, {
...
<div class="pageContent">
    ...
    <form method="post" action="/menu/insert" class="pageForm required-validate"
        ...
        <div class="pageFormContent nowrap" layoutH="97">
            ...
            <dl>
                <dt>链接：</dt>
                <dd>
                    <input type="text" name="href" class="" alt="" maxlength="40"/>
                </dd>
            </dl>
            <dl>
                <dt>目标：</dt>
                <dd>
                    <input type="text" name="target" class="" alt="" maxlength="40"/>
                </dd>
            </dl>
            <dl>
                <dt>图标：</dt>
            ...
            <dl>
                <dt>权限标识：</dt>
                <dd>
                    <input type="text" name="permission" class="" alt="" maxlength="60"/>

<h2 class="contentTitle">添加高级会员目录</h2>

<script>
    $("#productCatalogAdvancedBtn").click(function () {
        $.jBox.open("iframe:/product/catalog/advanced/tree/get", "选择", 300, 420, {
...
<div class="pageContent">
    <form method="post" action="/product/catalog/advanced/insert" class="pageForm required-validate"
          onsubmit="return validateCallback(this, navTabAjaxDone)">
        <div class="pageFormContent nowrap" layoutH="97">
            <dl>
                <dt>上级目录：</dt>
                <dd>
                    <input id="parent_id_hidden" name="parent_name_hidden" class="required" type="hidden" value="-1">
                    <input type="text" id="parent_id" name="parent_name" maxlength="20" class="required" alt=""
                           readonly="readonly"/>
                    <a id="productCatalogAdvancedBtn" class="button" href="javascript:void(0)"

<form id="pagerForm" method="post" action="/shop/all/list/get">
...
<div class="pageHeader">
    <form id="shop_all" onsubmit="return navTabSearch(this);" action="/shop/all/list/get" method="post"
...
<div class="pageContent">
            ...
            <#list page.data as shop>
                <tr id="${(shop.id)!}" target="sid_user"
                    ...
                    <td style="text-align: center !important;">
                        <a class="button" href="/shop/avatar?avatar=${shop.shopAvatar!}" target="dialog" rel="dlg_shop"
                           width="800" height="600"
                           fresh="true"><span>查看</span></a>
                    </td>
                    <td><a class="button" href="/shop/avatar?avatar=${shop.shopLicense!}" target="dialog" rel="dlg_shop"
                           width="800" height="600"
                           fresh="true"><span>查看</span></a>
                    </td>
                    <td>
                        <#if shop?? && shop.status??>
                            ...
                            <#--<a title="通过" target="navTab" href="/shop/pass?id=${(shop.id)!}" class="btnAttach">通过</a>-->
                                <a title="确认要审核通过?" target="ajaxTodo" href="/shop/audit?id=${(shop.id)!}&status=1"
                                   class="btnSelect">通过</a>
                                <a title="拒绝" target="dialog" href="/shop/refuse/view?id=${(shop.id)!}"
    ...
    <div class="panelBar">
        <div class="pages">
            <span>显示</span>
            <select id="combox_shop_all" class="combox" name="numPerPage"

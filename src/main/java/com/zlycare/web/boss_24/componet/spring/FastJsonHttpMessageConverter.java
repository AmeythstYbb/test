...
import com.zlycare.web.boss_24.componet.json.JSONHandler;
...
public class FastJsonHttpMessageConverter extends AbstractHttpMessageConverter<Object> {
    ...
    protected void writeInternal(Object obj, HttpOutputMessage outputMessage)
        ...
        byte[] bytes;
        String text;
        if (filter != null && features != null && features.length > 0) {
            text = JSONHandler.toJSONStringWithFilter(obj, filter, features);

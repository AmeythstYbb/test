...
public class ShopVo {
    ...
    public Date getOpReviewdTime() {
        return opReviewdTime;
    }

    public void setOpReviewdTime(Date opReviewdTime) {
        this.opReviewdTime = opReviewdTime;
    }
}

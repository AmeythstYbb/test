 ...
 */
package com.zlycare.web.boss_24.utils.other;
...
public class Page<T> {
	...
	public String toString() {
		...
		sb.append("<li class=\"disabled\"><a href=\"javascript:\" style=\"border:0;padding-top:1px;_padding-top:7px;\">当前 第");
		sb.append("<input type=\"text\" value=\""+pageNo+"\" style=\"width:30px;padding:0;margin:0 2px 3px 2px;text-align:center;\"");
		sb.append("onkeypress=\"if(window.event.keyCode==13) "+funcName+"(this.value,"+pageSize+");\"/> 页 / 共");
		sb.append("<input type=\"text\" value=\""+ last +"\" style=\"width:30px;padding:0;margin:0 2px 3px 2px;text-align:center;\"");
		sb.append("onkeypress=\"if(window.event.keyCode==13) "+funcName+"("+pageNo+",this.value);\"/> 页，");

package com.zlycare.web.boss_24.utils.http;
...
public class http {
    ...
    public static final String POST_URL = "http://api.bate.juliye.net/1/open/news";
    ...
    public static void httpURLConnectionPOST() {
        try {
            ...
            String account = "account=" + URLEncoder.encode("805001409", "utf-8");
            String content = "content=" + URLEncoder.encode("999999999999999", "utf-8");

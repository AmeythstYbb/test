...
public class MenuBo {
	...
	private List<MenuBo> childList = Lists.newArrayList();// 拥有子菜单列表
	...
	//原始代码
//	public static void sortList(List<MenuBo> list, List<MenuBo> sourcelist, Long parentId){
